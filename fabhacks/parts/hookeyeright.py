...
class HookEyeRight(Part):
    def __init__(self):
        super().__init__()
        self.tid = PartType.HookEyeRight
        self.name_in_assembly = self.__class__.__name__ + "_" + str(self.id)
        self.part_obj_path = os.path.join(".", Part.temp_dir, "HookEyeRight.obj")
...
class HookEyeConnector(Part):
    def __init__(self):
        ...
        self.is_concave = True
        self.child_symmetry_groups = [0, 1]
        self.init_mesh_metrics("hookeyeright")
